...
!`ls "personality-switcher/personalities" | sed 's/\.md$//'`
...
- Otherwise:
  1. Read `personality-switcher/personalities/$ARGUMENTS.md`. If it does not exist, tell the user that personality is not available, show the list above, and stop.
